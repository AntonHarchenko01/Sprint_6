...
class TestQaScooterQuestionsPage:
    ...
    def test_questions_click_first_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.FIRST_ANSWER)
        assert answer.is_displayed() and answer.text == QaScooterHomePageAnswers.answer1, 'Ответ на первый вопрос не соответствует ожидаемому значению'
    ...
    def test_questions_click_second_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.SECOND_ANSWER)
    ...
    def test_question_click_third_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.THIRD_ANSWER)
    ...
    def test_question_click_fourth_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.FOURTH_ANSWER)
    ...
    def test_question_click_fifth_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.FIFTH_ANSWER)
    ...
    def test_question_click_sixth_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.SIXTH_ANSWER)
    ...
    def test_question_click_seventh_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.SEVENTH_ANSWER)
    ...
    def test_question_click_eighth_question_show_answer(self, driver):
        ...
        answer = qa_scooter_home_page.find_element(QaScooterHomePageLocators.EIGHTH_ANSWER)
