class QaScooterHomePageAnswers:
...
class QaScooterOrderPageCorrectData:
    correct_data1 = {
        'name' : 'Иван',
        'surname' : 'Иванов',
        'address' : 'Иванова улица',
        'metro_station' : 'Черкизовская',
        'telephone_number' : '89181111111',
        'date' : '30.12.2024',
        'rental_period' : 1,
        'color' : 1,
        'comment_for_the_courier' : 'Встречу у пятого дома'
    }
    ...
    correct_data2 = {
        ...
        'telephone_number' : '89182222222',
        'date' : '31.12.2024',
        'rental_period' : 2,
        'color' : 0,
        'comment_for_the_courier' : 'Встречу у станции метро'
    }